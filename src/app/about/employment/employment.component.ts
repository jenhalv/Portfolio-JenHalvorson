...
export class EmploymentComponent implements OnInit {
  // JOBS = [
  //   {
  //   title: 'SELF-EMPLOYED Front End Developer<br>QA Tech<br>Blog Content Manager<br>Social Media Marketer',
  ...
  onClickScroll(projectId: string): void {
    this.viewportScroller.scrollToAnchor(projectId);
    console.log(projectId, 'click');
  }
}
